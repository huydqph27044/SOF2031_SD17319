        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Quản lý nhân viên</h1>

                    <div class="add">
                        <a href="${pageContext.request.contextPath}/admin/staff/create" class="btn btn-success">
                        ...
                        <c:if test="${f:length(listnvien) != 0}">
                            <c:forEach items="${listnvien}" var="nv">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/admin/staff/edit/${nv.id}"
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/admin/staff/delete/${nv.id}"
