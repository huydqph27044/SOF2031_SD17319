            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <frm:form method="POST"
                              ...
                              action="${pageContext.request.contextPath}/admin/staff/edit/${users.id}"
                        ...
                        <div class="col-md-3">
                            ...
                            <frm:input type="text" class="form-control" path="phonenumber"
                        ...
                        <div class="col-md-4">
                            ...
                            <frm:select class="form-select" id="validationCustom10" path="role">
                                <frm:option value="0" selected="${users.role==0?'selected':''}">Quản lý</frm:option>
                                <frm:option value="1" selected="${users.role=1?'selected':''}">Nhân viên</frm:option>
                            </frm:select>
                        </div>
